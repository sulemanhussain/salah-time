        ...
        <>
            <div className='min-h-screen bg-gradient-to-b from-blue-50 to-white'>
                ...
                <div className='max-w-6xl mx-auto p-6 space-y-6'>
                    ...
                    {/* Action Buttons */}
                    <div className='flex gap-3 justify-center flex-wrap' style={{ transform: "scale(0.8)" }}>
                        <button
                            type='button'
                            onClick={updateTimings}
                            className='group inline-flex items-center gap-3 px-6 py-3 bg-gradient-to-r from-emerald-600 to-green-600 hover:from-emerald-700 hover:to-green-700 text-white font-semibold rounded-xl shadow-lg shadow-emerald-200 transition duration-200'
                        >
                        ...
                        <button
                            type='button'
                            onClick={report}
                            className='group inline-flex items-center gap-3 px-6 py-3 bg-gradient-to-r from-rose-500 to-orange-500 hover:from-rose-600 hover:to-orange-600 text-white font-semibold rounded-xl shadow-lg shadow-rose-200 transition duration-200'
                        >
                            <span className='flex h-8 w-8 items-center justify-center rounded-lg bg-white/20 ring-1 ring-white/30'>
